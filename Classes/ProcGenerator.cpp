...
ProcGenerator::ProcGenerator() : current_sequence(nullptr) {
...
void ProcGenerator::generateObstacle(SharkMan *player, cocos2d::Node *render_node) {
    auto sequence = pump();
    switch (sequence.L) {
        case MONSTER: {
            auto a = new Obstacle();
...
void ProcGenerator::randomGenerate(SharkMan *player, cocos2d::Node *render_node, float dt) {
    static float step = 0;
...
void ProcGenerator::generateScene(SharkMan *player, cocos2d::Node *render_node) {
...
void ProcGenerator::insertMapSequence(MapSequence *map_sequence) {
    this->sequence_list.push_back(map_sequence);
}

SequenceInfo ProcGenerator::pump() {
...
void ProcGenerator::generateGround(cocos2d::Node *render_node) {
...
void ProcGenerator::preGenerate(cocos2d::Node *render_node) {
